...
public class GroupHelper {
    ...
    public void createGroup() {
        ...
        manager.driver.findElement(By.name("group_name")).sendKeys("");
        manager.driver.findElement(By.name("group_header")).click();
        manager.driver.findElement(By.name("group_header")).sendKeys("");
        manager.driver.findElement(By.name("group_footer")).click();
        manager.driver.findElement(By.name("group_footer")).sendKeys("");
